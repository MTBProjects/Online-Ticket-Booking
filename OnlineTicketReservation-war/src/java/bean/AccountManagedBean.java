...
public class AccountManagedBean {
    ...
    private Date currentDate; //newly added
    ...
    public void checkDuplicateUsername() {
        ...
        for (Account cust : getAllAccount()) {
            if (entity.getUsername().equals(cust.getUsername())) {
                isExist = true;
            }
        }
        if (isExist) {
            ...
            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
                    ...
                    "Please register another username"));
        } else {
            FacesContext context = FacesContext.getCurrentInstance();

            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,
                    "This username is available!", "You can use it to register"));
        }
    }
